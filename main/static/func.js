...
function update_ints_count() {
    ...
    $.ajax({ 
        ...
        .done(function(data) {
            ...
            var e1 =  (data['E1'] != undefined ?  ((hexToFloat("0x"+data['E1'].toString(16)))/1000).toFixed(3): 0.0 )
            var e2 =  (data['E2'] != undefined ?  ((hexToFloat("0x"+data['E2'].toString(16)))/1000).toFixed(3): 0.0 )
            var e3 =  (data['E3'] != undefined ?  ((hexToFloat("0x"+data['E3'].toString(16)))/1000).toFixed(3): 0.0 )
            var energy = e1 + e2+ e3
            console.log(energy)
